...
prefix = $(DESTDIR)/Users/aikawa/.rbenv/versions/2.0.0-p195
...
DEFS     = 
CPPFLAGS =  -I'/Users/aikawa/.rbenv/versions/2.0.0-p195/include'  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) $(cxxflags) $(ARCH_FLAG)
ldflags  = -L. -L'/Users/aikawa/.rbenv/versions/2.0.0-p195/lib' 
...
ORIG_SRCS = example.cc example_wrap.cxx
SRCS = $(ORIG_SRCS) 
...
pre-install-rb-default:
	$(ECHO) installing default example libraries
./.RUBYARCHDIR.time:
